...
function Descriptors.Init(vk, device, bufCPU_A, bufCPU_B, bufPing, bufPong, bufDrawCmd)
    ...
    -- ========================================================
    local ssboBindings = ffi.new("VkDescriptorSetLayoutBinding[4]") -- INCREASED TO 4
    ...
    layoutInfo.sType = 32 
    layoutInfo.bindingCount = 4                     -- UPDATED TO 4
    ...
    -- Set 0 (Even Frames): 0=CPU_A, 1=Ping, 2=Pong, 3=DrawCmd
    ...
    writes[3].sType = 35; writes[3].dstSet = pSets[0]; writes[3].dstBinding = 3; writes[3].descriptorType = 7; writes[3].descriptorCount = 1; writes[3].pBufferInfo = bufInfoDrawCmd -- ADDED

    -- Set 1 (Odd Frames): 0=CPU_B, 1=Pong, 2=Ping, 3=DrawCmd
    ...
    writes[7].sType = 35; writes[7].dstSet = pSets[1]; writes[7].dstBinding = 3; writes[7].descriptorType = 7; writes[7].descriptorCount = 1; writes[7].pBufferInfo = bufInfoDrawCmd -- ADDED

    vk.vkUpdateDescriptorSets(device, 8, writes, 0, nil) -- UPDATED TO 8
